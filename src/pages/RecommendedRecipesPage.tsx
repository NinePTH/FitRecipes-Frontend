...
import { getRecommendedRecipes } from '@/services/recipe';
import type { Recipe } from '@/types';

export function RecommendedRecipesPage() {
  ...
  useEffect(() => {
    ...
    const fetchRecipes = async () => {
      setLoading(true);
      try {
        const response = await getRecommendedRecipes(RECIPES_PER_PAGE);
  ...
  const loadMoreRecipes = async () => {
    ...
    try {
      // Note: Backend might need pagination support for recommended recipes
      const response = await getRecommendedRecipes(RECIPES_PER_PAGE * (currentPage + 1));
    ...
    <Layout>
      <div className="space-y-8">
        ...
        <div className="text-center space-y-4">
          <h1 className="text-4xl font-bold text-gray-900">Recommended Recipes</h1>
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">
              Browse recipes and rate them to get personalized recommendations
            </p>
