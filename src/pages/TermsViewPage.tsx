  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-primary-100 py-8 px-4">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-3xl text-center">Terms of Service & Privacy Policy</CardTitle>
          </CardHeader>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="space-y-3">
                  ...
                  <p className="leading-relaxed">
                    By accessing or using FitRecipes, you agree to be bound by these Terms of Service
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mt-6">2. User Responsibilities</h3>
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mt-6">3. Content Guidelines</h3>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    ...
                    <li>Prohibited content includes: hate speech, harassment, spam, illegal content</li>
                  </ul>
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mt-6">7. Disclaimer of Warranties</h3>
                  <p className="leading-relaxed">
                    The platform is provided "as is" without any warranties, express or implied. We do
                    not warrant that the service will be uninterrupted, error-free, or secure. Use of
                    recipes and nutritional information is at your own risk.
                  </p>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="space-y-3">
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    ...
                    <li>
                      <strong>OAuth Information:</strong> When you sign in with Google, we receive your
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mt-6">5. Cookies and Tracking</h3>
                  <p className="leading-relaxed">
                  ...
                  <p className="leading-relaxed">
                    ...
                    with our services and as required by law. You can request deletion of your account
                    and data at any time through your account settings.
                  </p>
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mt-6">9. Changes to Privacy Policy</h3>
                  <p className="leading-relaxed">
